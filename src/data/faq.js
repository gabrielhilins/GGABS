export const faqData = [
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "Vocês usam templates prontos (Wix/Wordpress)?", answer: "Priorizamos o desenvolvimento sob medida em código, com tecnologias de ponta para garantir performance máxima, segurança e design exclusivo. Porém, podemos usar CMS se for uma exigência específica do projeto para redução de custos." },
